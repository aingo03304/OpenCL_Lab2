...
# Lab assignment 2 - OpenCL Tiled Matrix Multiplication 
...
The following will compile the template file that you will modify to implement tile matrix multiplication in OpenCL, and the data generator that will generate input files. 
